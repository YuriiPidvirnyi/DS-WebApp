      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Остання редакція: 17 жовтня 2024 року
          </p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Ці Умови використання (далі - "Умови") регулюють використання веб-сайту 
              та послуг стоматологічної клініки "Dental Story" (далі - "Клініка", "ми"). 
              Використовуючи наш веб-сайт або послуги, ви погоджуєтеся дотримуватися цих умов.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Якщо ви не погоджуєтеся з будь-якою частиною цих умов, 
              будь ласка, не використовуйте наш веб-сайт або послуги.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              або способами, що можуть пошкодити роботу сайту або репутації клініки.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Запис на прийом:</h3>
                <ul className="list-disc pl-6 text-gray-700 space-y-1">
                  <li>Запис здійснюється через веб-сайт, телефон або особисто</li>
                  <li>Підтвердження запису надходить протягом 30 хвилин</li>
                  <li>При записі необхідно надавати достовірну інформацію</li>
                </ul>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Скасування:</h3>
                <ul className="list-disc pl-6 text-gray-700 space-y-1">
                  <li>Скасування можливе за 24 години до візиту</li>
                  <li>При скасуванні менше ніж за 24 години може стягуватися штраф</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Наша клініка надає медичні послуги згідно з чинним законодавством України:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Результат лікування може варіюватися залежно від індивідуальних особливостей 
              організму пацієнта. Клініка не несе відповідальність за результати, 
              що не відповідають очікуванням пацієнта, якщо лікування проводилося 
              згідно з медичними стандартами.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>Лікування оплачується перед початком або після завершення</li>
                <li>Приймаються готівкові та безготівкові платежі</li>
                <li>При відмові від лікування кошти за консультацію не повертаються</li>
                <li>Повернення коштів за недоотримані послуги здійснюється протягом 14 днів</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Клініка надає гарантії на виконані роботи згідно з медичними стандартами:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Гарантія не поширюється на випадки недотримання пацієнтом рекомендацій лікаря, 
              механічних пошкоджень або природного зносу.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <Link to="/privacy-policy" className="text-dental-teal hover:underline">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Всі матеріали на цьому веб-сайті, включаючи текст, зображення, логотипи 
              та дизайн, є власністю клініки "Dental Story" або використовуються 
              з дозволу правовласників. Копіювання або використання без письмового 
              дозволу заборонено.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Ми залишаємо за собою право оновлювати ці Умови використання в будь-який час. 
              Про суттєві зміни ми повідомляємо на веб-сайті або через електронну пошту. 
              Продовжене використання наших послуг після оновлення умов означає 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              досягти згоди, спори вирішуються в судовому порядку згідно 
              з законодавством України. Юрисдикція: суди міста Києва.
            </p>
          </section>
