  ...
  return (
    <div className="py-16">
      <Helmet>
        ...
        <meta name="description" content="Як ми збираємо, зберігаємо та обробляємо ваші персональні дані. Конфіденційність пацієнтів — наш пріоритет." />
        <link rel="canonical" href="https://dentalstory.com.ua/privacy-policy" />
      </Helmet>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Стоматологічна клініка "Dental Story" (далі - "Клініка", "ми") поважає вашу 
              конфіденційність та зобов'язується захищати персональні дані, які ви надаєте нам. 
              Ця Політика конфіденційності пояснює, як ми збираємо, використовуємо та захищаємо 
              вашу інформацію.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Використовуючи наш веб-сайт або послуги, ви погоджуєтеся з умовами цієї 
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Медична історія та інформація про стан здоров'я ротової порожнини</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              ваших персональних даних від несанкціонованого доступу, втрати, знищення 
              або розкриття:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Обмежений доступ до персональних даних лише уповноваженому персоналу</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Ми не продаємо, не обмінюємо та не передаємо ваші персональні дані третім особам, 
              за винятком випадків, передбачених законом України, або за вашою згодою. 
              Можлива передача даних медичним лабораторіям або страховим компаніям 
              у рамках надання медичних послуг.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Наш веб-сайт може використовувати файли cookie для покращення користувацького 
              досвіду. Ви можете налаштувати свій браузер для відмови від cookie, 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Ми зберігаємо ваші персональні дані тільки стільки, скільки необхідно 
              для досягнення мети їх обробки або відповідно до вимог законодавства. 
              Медичні дані зберігаються згідно з вимогами медичного законодавства України.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Про будь-які зміни ми повідомимо на нашому веб-сайті. Дата останньої 
              редакції вказана на початку документа.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Якщо у вас є питання щодо цієї Політики конфіденційності або обробки 
              ваших персональних даних, зв'яжіться з нами:
            </p>
