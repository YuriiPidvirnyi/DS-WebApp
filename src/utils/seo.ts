...
export function generateOrganizationSchema(): MedicalBusiness {
  return {
    ...
    address: {
      '@type': 'PostalAddress',
      streetAddress: 'вулиця Сумська, 10',
