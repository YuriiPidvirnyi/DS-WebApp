    ...
    const handleClick = (event: MouseEvent) => {
      ...
      while (target && target !== document.body) {
        if (target.hasAttribute('data-track-id')) {
          ...
          const trackCategory = target.getAttribute('data-track-category') || AnalyticsEventCategory.Engagement;
          ...
          // Track the event
          trackEvent(trackId || EngagementEvent.ClickElement, trackCategory as AnalyticsEventCategory, trackData);
          break;
        }
