...
const uk = {
  ...
  home: {
    hero: {
      title: 'Ваша посмішка - наша місія',
      description:
  ...
  testimonials: {
    ...
    subtitle:
      "Щастя наших пацієнтів - наша найкраща нагорода. Читайте реальні відгуки людей, які довірили нам своє здоров'я",
    rating: 'Рейтинг: {{rating}} з 5 зірок',
    basedOn: 'на основі {{count}} відгуків',
    cta: {
      question: "Хочете стати частиною нашої щасливої сім'ї пацієнтів?",
