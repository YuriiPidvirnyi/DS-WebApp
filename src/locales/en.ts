...
const en = {
  ...
  footer: {
    ...
    workingHours: {
      weekdays: 'Mon-Fri: {{open}}-{{close}}',
      saturday: 'Sat: {{open}}-{{close}}',
      sunday: 'Sun: Closed',
    },
  ...
  admin: {
    ...
    stock: {
      ...
      page: {
        heading: 'Stock v2',
        subtitle:
          'Manage warehouse, materials and consumption. All 8 phases implemented.',
        documentsTitle: 'Documents',
        documentsDesc: 'Receipts, write-offs, transfers, returns, adjustments',
        warehousesTitle: 'Warehouses',
        warehousesDesc: "Main warehouse, offices, doctors' warehouses",
        directoriesTitle: 'Directories',
        directoriesDesc: 'Suppliers, brands, material categories',
        materialsTitle: 'Materials',
        materialsDesc: 'Product card, barcodes, packaging, warehouse matrix',
        myWarehousesTitle: 'My warehouses',
        myWarehousesDesc:
          'Daily operations: balances, write-offs, transfers, requests',
        calcCardsTitle: 'Calculation cards',
        calcCardsDesc:
          'Material consumption norms per service, product substitution',
        auditsTitle: 'Inventory audit',
        auditsDesc: 'Stock recount acts, adjustment documents',
        settingsTitle: 'Settings',
        settingsDesc: 'Write-off mode, permissions, additional settings',
        reportsTitle: 'Reports',
        reportsDesc: 'Balances, cost price, turnover, critical stock',
        comingSoonBadge: 'soon',
        footerHeading: 'All 8 phases complete',
        footerPhases:
          '— Reports, metrics, balances, cost price, calculation cards, inventory audit.',
        stockV1Link: 'Stock v1',
        footerNote: 'continues to run in parallel.',
      },
      materialsPage: {
      ...
      materialDetailPage: {
        ...
        packFormatPlaceholder: 'Jar, Vial, Pack...',
        packQtyLabel: 'Qty per pack',
        packUnitLabel: 'Unit per pack',
        barcodesHeading: 'Barcodes and article code',
        articleLabel: 'Article code',
        addBarcodeLabel: 'Add barcode',
        warehouseMatrixHeading: 'Warehouse matrix',
      ...
      documentsPage: {
        docTypeIncoming: 'Receipt',
        docTypeWriteoff: 'Write-off',
        docTypeReturn: 'Return',
        docTypeTransfer: 'Transfer',
        docTypeAdjustment: 'Adjustment',
        statusDraft: 'Draft',
        statusPosted: 'Posted',
        statusVoid: 'Voided',
      ...
      documentDetailPage: {
        ...
        columnTotal: 'Total',
        reason: 'Reason',
        reasonPlaceholder: 'Minimum 3 characters...',
        cancel: 'Cancel',
        confirm: 'Confirm',
      },
      directoriesPage: {
        ...
        supplierAccusative: 'supplier',
        brandNoun: 'brand',
        categoryAccusative: 'category',
        newTitlePrefix: 'New',
        supplierNominative: 'supplier',
        categoryNominative: 'category',
        nameLabel: 'Name',
        phoneLabel: 'Phone',
        edrpouLabel: 'EDRPOU',
      ...
      settingsPage: {
        writeoffModeNoneLabel: 'No auto write-off',
        writeoffModeDraftHybridLabel: 'Draft auto write-off (recommended)',
        writeoffModeAutoLabel: 'Fully automatic',
        writeoffModeNoneHint:
          'Materials are not written off automatically when an appointment is completed.',
        writeoffModeDraftHybridHint:
          'When an appointment is completed, a write-off draft is created automatically based on the calculation cards. Staff can edit it and post it manually.',
        writeoffModeAutoHint:
          'The draft is created and posted immediately. Recommended only after the calculation cards have stabilized (>90 days).',
        loadError: 'Failed to load settings',
        saveError: 'Save error',
        title: 'Warehouse settings',
        writeoffModeHeading: 'Material auto write-off type',
        additionalParamsHeading: 'Additional parameters',
        allowNegativeBalanceLabel: 'Allow negative balance',
        allowNegativeBalanceHint:
          'Recommended to enable for the first 30–60 days after launch to gradually enter stock balances.',
        enforcePermissionsLabel: 'Enforce access permissions',
        enforcePermissionsHint:
          'If disabled — all employees have full access to all warehouses.',
        showMyInventoryLabel: 'Show "My inventory"',
        showMyInventoryHint:
          'Personal per-warehouse balance check for each employee.',
        saved: 'Saved',
        save: 'Save',
      },
      permissionsPage: {
        flagManageWarehouses: 'Manage warehouses',
        flagEditBrands: 'Edit brands',
        flagEditProducts: 'Edit products',
        flagEditCategories: 'Edit categories',
        flagEditSuppliers: 'Edit suppliers',
        flagManagePermissions: 'Manage permissions',
        flagManageCalcCards: 'Manage calc cards',
        flagManageSettings: 'Module settings',
        flagViewOtherBalances: "View other users' balances",
        flagBaseAccess: 'Base access',
        flagViewIncoming: 'View receipts',
        flagEditIncoming: 'Edit receipts',
        flagViewReturn: 'View returns',
        flagEditReturn: 'Edit returns',
        flagViewTransfer: 'View transfers',
        flagEditTransfer: 'Edit transfers',
        flagViewWriteoff: 'View write-offs',
        flagCreateWriteoff: 'Create write-offs',
        flagUnpostWriteoff: 'Unpost write-offs',
        flagDeleteDraftWriteoff: 'Delete write-off drafts',
        flagViewAudit: 'View inventory audits',
        flagPostAudit: 'Post inventory audits',
        errorLoad: 'Loading error',
        errorSave: 'Save error',
        title: 'Warehouse access permissions',
        allWarehouses: 'All warehouses',
        noPermissions: 'No permissions set',
        warehousePermissionsSummary:
          'Warehouse: {{warehouseId}} · {{count}} permissions active',
        edit: 'Edit',
        delete: 'Delete',
        modalTitle: 'Access permissions',
        cancel: 'Cancel',
        save: 'Save',
      },
      auditsPage: {
        ...
        newAudit: 'New act',
        emptyState: 'No inventory audits yet',
        createFirst: 'Create the first act →',
        columnNumber: 'Number',
        columnDate: 'Date',
        columnStatus: 'Status',
        edit: 'Edit',
      ...
      auditEditorPage: {
        errorLoad: 'Loading error',
        errorSave: 'Save error',
        errorAutofill: 'Auto-fill error',
        errorPost: 'Posting error',
        titleFallback: 'Inventory audit',
        statusPosted: 'Posted',
        statusVoid: 'Voided',
        autofill: 'Auto-fill',
        saved: 'Saved',
        save: 'Save',
        saveFirstTooltip: 'Save your changes first',
        post: 'Post',
        noItems: 'No items — go back and re-initialise',
        columnMaterial: 'Material',
      ...
      auditNewPage: {
        errorSelectWarehouse: 'Select at least one warehouse',
        errorCreate: 'Creation error',
        title: 'New inventory act',
        auditDate: 'Audit date',
        warehouses: 'Warehouses',
        noWarehouses: 'No warehouses found',
        categories: 'Categories',
        categoriesHint: '(optional — all categories if none selected)',
        brands: 'Brands',
        brandsHint: '(optional)',
        comment: 'Comment',
      ...
      calcCardsPage: {
        ...
        subtitle: 'Material consumption norms per service',
      ...
      reports: {
        hub: {
          balancesTitle: 'Stock balances',
          balancesDesc:
            'Current balances of materials across warehouses, with status and average cost.',
          historyTitle: 'Item history',
          historyDesc:
            'Movement of a specific material in a warehouse: receipts, write-offs, adjustments.',
          reorderTitle: 'Critical-stock reorder',
          reorderDesc:
            'Materials below the critical limit, with a suggested reorder quantity.',
          writeoffTitle: 'Write-offs',
          writeoffDesc: 'Detailed write-off log for the selected period.',
          serviceCostTitle: 'Service cost',
          serviceCostDesc:
            'Average price, material cost and margin per service, broken down by month.',
          title: 'Warehouse reports',
        },
        balances: {
          loadError: 'Loading error',
          title: 'Stock balances',
          balanceStateLabel: 'Balances',
          optionAll: 'All',
          ...
          statusZero: 'Zero',
          emptyPrompt: 'Click «Generate» to build the report',
        },
        history: {
          selectMaterialWarehouse: 'Select a material and warehouse',
          loadError: 'Loading error',
          title: 'Item history',
          ...
          colBalance: 'Balance',
          colActor: 'By whom',
          emptyPrompt: 'Select a material and warehouse, then click «Generate»',
        },
        reorder: {
          loadError: 'Loading error',
          title: 'Reorder with critical stock',
          description:
            'Materials whose current stock is below the critical limit. Suggested order quantity = default or limit × 2.',
          build: 'Generate',
          colMaterial: 'Material',
          ...
          colLimit: 'Limit',
          colOrder: 'Order',
          emptyState: 'Click “Generate” to check critical stock levels',
        },
        serviceCost: {
          loadError: 'Loading error',
          title: 'Service cost',
          openingBalanceNote:
            'Materials entered as opening balances (cost = 0) are not included in the margin calculation. During the first 30–60 days of working with the system, the figures will be incomplete.',
          build: 'Generate',
          ...
          colQty: 'Qty',
          colAvgPrice: 'Avg. price',
          colAvgMaterials: 'Avg. materials',
          colAvgMargin: 'Avg. margin',
          colTotalMargin: 'Total margin',
          emptyState: 'Select a period and click “Generate”',
        },
        writeoff: {
          loadError: 'Loading error',
      ...
      actionCart: {
        ...
        title: 'Action cart',
        destinationWarehousePlaceholder: '— destination warehouse —',
        post: 'Post',
      },
      barcodeInput: {
      ...
      calcCardEditor: {
        saveError: 'Failed to save',
        title: 'Calculation card',
        active: 'Active',
        addMaterial: 'Add material',
        searchPlaceholder: 'Search material...',
        emptyState: 'No items — add materials above',
  ...
  cabinet: {
    ...
    payments: {
      ...
      empty: {
        title: 'No payments',
        description:
          'Your online payments for clinic services will appear here.',
  ...
  payments: {
    ...
    monoButton: {
      ...
      scriptError: 'Failed to load the payment module',
    },
  },
  walletCards: {
    title: 'Saved cards',
