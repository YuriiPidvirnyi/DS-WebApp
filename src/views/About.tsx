  ...
  return (
    <div className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero + Stats — перший повний екран: фолд не ріже наступний блок */}
        <div className="snap-start snap-screen flex flex-col justify-center">
        ...
        {/* Our Story — grid: центрування екрана через content-center */}
        <div className="snap-start snap-screen content-center grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold text-dental-dark">
              {t('about.story.title')}
            </h2>
        ...
        <div className="snap-start snap-screen flex flex-col justify-center">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-dental-dark mb-6">
              {t('about.values.title')}
            </h2>
            <p className="text-xl text-dental-muted max-w-2xl mx-auto">
        ...
        {/* Team — коли API лікарів недоступне/порожнє, блок ховається цілком:
            заголовок без жодної картки виглядав як зламана секція */}
        ...
        <div className="snap-start snap-screen flex flex-col justify-center">
          <Card variant="brand" padding="xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl font-bold text-dental-dark mb-6">
