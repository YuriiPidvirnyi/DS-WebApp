      ...
      <div className="mt-3 mb-4 flex flex-wrap items-end gap-3 rounded-xl border bg-white p-4">
        ...
        {rows.length > 0 && (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-dental-secondary-200 px-3 py-2 text-sm text-dental-text hover:bg-dental-secondary-50"
          >
