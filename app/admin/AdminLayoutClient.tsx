  ...
  return (
    <div className="min-h-screen bg-dental-secondary-50">
      ...
      <aside
        ...
        aria-label={t('admin.layout.sidebarNav')}
      >
        {/* min-h-0 lets this column shrink to the fixed aside height so the
            flex-1 <nav> below becomes a bounded scroll area. Without it the
            column grows to its full content height and the nav never scrolls —
            bottom items + footer (logout) end up unreachable off-screen. */}
